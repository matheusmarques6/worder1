...
-- ============================================================
-- PASSO 1: DROPAR TODAS AS POLICIES EXISTENTES PRIMEIRO
...
END $$;
DO $$ BEGIN
  DROP POLICY IF EXISTS "crm_forms_select" ON crm_forms;
EXCEPTION WHEN undefined_table THEN NULL;
END $$;
DO $$ BEGIN
  DROP POLICY IF EXISTS "crm_forms_insert" ON crm_forms;
EXCEPTION WHEN undefined_table THEN NULL;
END $$;
DO $$ BEGIN
  DROP POLICY IF EXISTS "crm_forms_update" ON crm_forms;
EXCEPTION WHEN undefined_table THEN NULL;
END $$;
DO $$ BEGIN
  DROP POLICY IF EXISTS "crm_forms_delete" ON crm_forms;
EXCEPTION WHEN undefined_table THEN NULL;
END $$;
...
END $$;
DO $$ BEGIN
  DROP POLICY IF EXISTS "crm_form_fields_select" ON crm_form_fields;
EXCEPTION WHEN undefined_table THEN NULL;
END $$;
DO $$ BEGIN
  DROP POLICY IF EXISTS "crm_form_fields_insert" ON crm_form_fields;
EXCEPTION WHEN undefined_table THEN NULL;
END $$;
DO $$ BEGIN
  DROP POLICY IF EXISTS "crm_form_fields_update" ON crm_form_fields;
EXCEPTION WHEN undefined_table THEN NULL;
END $$;
DO $$ BEGIN
  DROP POLICY IF EXISTS "crm_form_fields_delete" ON crm_form_fields;
EXCEPTION WHEN undefined_table THEN NULL;
END $$;
...
END $$;
DO $$ BEGIN
  DROP POLICY IF EXISTS "crm_form_submissions_select" ON crm_form_submissions;
EXCEPTION WHEN undefined_table THEN NULL;
END $$;
DO $$ BEGIN
  DROP POLICY IF EXISTS "crm_form_submissions_insert" ON crm_form_submissions;
EXCEPTION WHEN undefined_table THEN NULL;
END $$;
...
END $$;
DO $$ BEGIN
  DROP POLICY IF EXISTS "crm_form_events_select" ON crm_form_events;
EXCEPTION WHEN undefined_table THEN NULL;
END $$;
DO $$ BEGIN
  DROP POLICY IF EXISTS "crm_form_events_insert" ON crm_form_events;
EXCEPTION WHEN undefined_table THEN NULL;
END $$;
...
END $$;
DO $$ BEGIN
  DROP POLICY IF EXISTS "crm_form_event_logs_select" ON crm_form_event_logs;
EXCEPTION WHEN undefined_table THEN NULL;
END $$;
...
-- anon policies
DO $$ BEGIN
  DROP POLICY IF EXISTS "anon_select_forms" ON crm_forms;
EXCEPTION WHEN undefined_table THEN NULL;
END $$;
DO $$ BEGIN
  DROP POLICY IF EXISTS "anon_select_fields" ON crm_form_fields;
EXCEPTION WHEN undefined_table THEN NULL;
END $$;
DO $$ BEGIN
  DROP POLICY IF EXISTS "anon_insert_submissions" ON crm_form_submissions;
EXCEPTION WHEN undefined_table THEN NULL;
END $$;


-- ============================================================
-- PASSO 2: CRIAR/ATUALIZAR TABELAS
-- ============================================================
