...
--
-- NOTA DE BRANCH: esta auditoria mira o BANCO, nao o codigo — roda igual a
-- partir de qualquer branch. O codigo do inbox Cloud API que ela investiga
-- (hook de realtime, endpoint de token, migrations 2026-06/07) vive em
-- claude/debug-console-error-FWrLE, que e um historico independente deste
-- (as duas branches nao tem ancestral comum). Aqui esta a copia do arquivo,
-- para a auditoria ficar acessivel dos dois lados.
-- =====================================================================
...
--      A telemetria para distinguir os dois existe na branch
--      claude/debug-console-error-FWrLE: o hook useCloudInboxRealtime.ts
--      devolve `channels.messages`. Esta branch (jolly-fermi) NAO tem o
--      inbox Cloud API — o arquivo nao existe aqui.
--
