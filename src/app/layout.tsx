  ...
  return (
    <html lang="pt-BR">
      <head>
        ...
        {/* eslint-disable-next-line @next/next/no-page-custom-font -- Root layout owns global theme font delivery. */}
        ...
        {/* eslint-disable-next-line @next/next/no-page-custom-font -- Root registry supports runtime family selection. */}
        ...
        {/* Geist — design system das Configurações (.wset) */}
        {/* eslint-disable-next-line @next/next/no-page-custom-font -- Next.js 14 does not export Geist or Geist_Mono through next/font. */}
