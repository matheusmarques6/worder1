          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 pr-12 bg-white border border-gray-200 rounded-xl text-gray-900 text-lg font-medium focus:outline-none focus:border-orange-500"
              />
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="flex gap-2">
              <select
                ...
                className="w-24 px-3 py-3 bg-white border border-gray-200 rounded-xl text-gray-900 focus:outline-none focus:border-orange-500"
              >
                {CURRENCIES.map(c => (
              ...
              <input
                ...
                placeholder="0.00"
                className="flex-1 px-4 py-3 bg-white border border-gray-200 rounded-xl text-gray-900 focus:outline-none focus:border-orange-500"
                autoFocus
              />
            </div>
          </div>
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="flex-1 py-3 bg-orange-500 hover:bg-orange-600 disabled:bg-gray-100 disabled:text-gray-400 text-white rounded-xl font-medium transition-colors flex items-center justify-center gap-2"
            >
  ...
  return (
    <div className="flex items-center gap-1">
      <select
        value={currency}
        onChange={(e) => setCurrency(e.target.value)}
        className="w-16 px-1.5 py-1 bg-gray-100 border border-gray-300 rounded text-gray-900 text-xs focus:outline-none focus:border-orange-500"
      >
        {CURRENCIES.map(c => (
          <option key={c.code} value={c.code}>{c.code}</option>
        ))}
      ...
      <input
        ...
        onChange={(e) => setCost(e.target.value)}
        placeholder="0.00"
        className="w-20 px-2 py-1 bg-gray-100 border border-gray-300 rounded text-gray-900 text-sm focus:outline-none focus:border-orange-500"
        autoFocus
        onKeyDown={(e) => {
...
const ProductRow = ({
  ...
  return (
    <>
      <tr className={`border-b border-gray-200 hover:bg-gray-50 transition-colors ${isSelected ? 'bg-orange-500/5' : ''}`}>
        {/* Checkbox */}
                            ...
                            {editingVariant === variant.id ? (
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <button
                                  ...
                                  className="p-0.5 hover:bg-gray-100 rounded text-gray-500 hover:text-gray-900 transition-colors"
                                >
    ...
    <div className="space-y-6">
      ...
      <div className="p-4 bg-white rounded-xl border border-gray-200">
        ...
        <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
          <div
            className="h-full bg-gradient-to-r from-orange-500 to-accent-500 rounded-full transition-all duration-500"
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 bg-white border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:border-orange-500"
          />
        </div>
        ...
        <div className="flex items-center gap-2">
          <div className="flex items-center bg-white border border-gray-200 rounded-xl p-1">
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-all ${
                filter === 'with' ? 'bg-gray-100 text-gray-900' : 'text-gray-500 hover:text-gray-900'
              }`}
            >
              Com Custo
            </button>
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-all ${
                filter === 'without' ? 'bg-gray-100 text-gray-900' : 'text-gray-500 hover:text-gray-900'
              }`}
            >
              Sem Custo
            </button>
      ...
      <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
        {isLoading ? (
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead>
                <tr className="text-left text-xs text-gray-500 border-b border-gray-200 bg-white">
