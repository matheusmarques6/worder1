        ...
        <div className="p-4 border-b border-gray-200">
          <div className="flex items-center justify-between mb-2">
            ...
            >
              ...
              <h3 className="font-semibold text-gray-900 group-hover:text-brand-500 transition-colors">{stage.name}</h3>
        ...
        <div className="relative">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="pl-9 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-dark-400 focus:outline-none focus:border-brand-400 w-64 transition-colors"
            />
            {searchQuery && (
              <button
                      ...
                      <div className="flex items-center gap-3">
                        <div className="flex-1 relative">
                          ...
                          <input
                            ...
                            className="w-full pl-9 pr-3 py-2.5 bg-white/80 border border-gray-300/50 rounded-xl text-gray-900 text-sm placeholder-dark-500 focus:outline-none focus:border-brand-400 focus:ring-2 focus:ring-primary-500/20 transition-all"
                          />
                        </div>
