...
const statusConfig: Record<string, { label: string; color: string; bg: string; icon: any }> = {
  draft: { label: 'Rascunho', color: 'text-gray-500', bg: 'bg-gray-100', icon: FileText },
  ...
  cancelled: { label: 'Cancelada', color: 'text-gray-500', bg: 'bg-gray-100', icon: XCircle },
}
          ...
          {campaigns.map((campaign) => {
            ...
            return (
              <motion.div
                ...
                className="bg-gray-50 border border-gray-200 rounded-xl p-4 hover:border-gray-300 transition-all cursor-pointer group"
                ...
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {campaign.description && (
                      <p className="text-sm text-gray-500 mb-2 line-clamp-1">{campaign.description}</p>
                    )}
                  ...
                  {(campaign.status === 'completed' || campaign.status === 'running') && (
                    <div className="hidden md:flex items-center gap-6 text-center">
                      <div>
                        <p className="text-lg font-semibold text-gray-900">{campaign.total_sent}</p>
                  ...
                  <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                    {campaign.status === 'draft' && (
                      <button
                        ...
                        className="p-2 rounded-lg bg-brand-100 text-brand-600 hover:bg-primary-500/30 transition-colors"
                        title="Enviar"
                      >
                    ...
                    <button
                      ...
                      className="p-2 rounded-lg bg-gray-100 text-gray-500 hover:text-white hover:bg-gray-100 transition-colors"
                      title="Ver detalhes"
                    >
