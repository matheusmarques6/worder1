...
const statusConfig = {
  ...
  offline: { label: 'Offline', color: 'bg-gray-300', textColor: 'text-gray-500' },
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-3 mb-6">
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-xl p-3">
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-xl font-bold text-gray-900">{stats.humans}</p>
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-xl p-3">
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-xl font-bold text-gray-900">{stats.ais}</p>
              <p className="text-xs text-gray-500">IAs</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-xl p-3">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">Chats Ativos</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-4 mb-6">
            ...
            <button
              ...
              className={`px-3 py-2 rounded-xl text-sm font-medium transition-all ${
                filterType === type
                  ...
                  : 'bg-gray-50 border border-gray-200 text-gray-500 hover:text-white'
              }`}
            >
        ...
        <div className="flex gap-2">
          <button
            onClick={fetchAgents}
            disabled={loading}
            className="p-2.5 rounded-xl bg-gray-50 border border-gray-200 text-gray-500 hover:text-white hover:bg-gray-100 transition-colors disabled:opacity-50"
          >
        ...
        <div className="space-y-6">
          ...
          {humanAgents.length > 0 && (filterType === 'all' || filterType === 'human') && (
            <div>
              <div className="flex items-center gap-2 mb-3">
                <User className="w-4 h-4 text-blue-400" />
                <h3 className="text-sm font-medium text-gray-900">Agentes Humanos</h3>
          ...
          {aiAgents.length > 0 && (filterType === 'all' || filterType === 'ai') && (
            <div>
              <div className="flex items-center gap-2 mb-3">
                <Bot className="w-4 h-4 text-purple-400" />
                <h3 className="text-sm font-medium text-gray-900">Agentes de IA</h3>
...
function AgentCard({
  ...
  return (
    <motion.div
      ...
      className={`bg-gray-50 border rounded-xl p-4 transition-all group ${
        agent.is_active ? 'border-gray-200 hover:border-gray-300' : 'border-gray-200 opacity-60'
      }`}
    >
      {/* Header */}
      <div className="flex items-start justify-between mb-3">
        <div className="flex items-center gap-3">
          <div className={`relative w-10 h-10 rounded-xl flex items-center justify-center ${
            agent.is_active ? typeInfo.bgColor : 'bg-gray-100'
          }`}>
            <TypeIcon className={`w-5 h-5 ${agent.is_active ? typeInfo.color : 'text-gray-400'}`} />
      ...
      <div className="grid grid-cols-3 gap-2 mb-3">
        <div className="text-center p-1.5 bg-gray-50 rounded-lg">
          <p className="text-sm font-semibold text-gray-900">{agent.stats?.active_chats || 0}</p>
          <p className="text-[10px] text-gray-400">Ativos</p>
        </div>
        <div className="text-center p-1.5 bg-gray-50 rounded-lg">
          <p className="text-sm font-semibold text-gray-900">{agent.total_conversations || 0}</p>
      ...
      <div className="flex items-center gap-2 pt-2 border-t border-gray-200">
        <button
          onClick={onEdit}
          className="flex-1 flex items-center justify-center gap-1.5 py-1.5 rounded-lg bg-gray-100 text-gray-600 hover:text-white hover:bg-gray-100 transition-colors text-sm"
        >
        ...
        <button
          onClick={onDelete}
          className="p-1.5 rounded-lg bg-gray-100 text-gray-500 hover:text-red-400 hover:bg-red-500/10 transition-colors"
        >
