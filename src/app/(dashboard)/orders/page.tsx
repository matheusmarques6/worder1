            ...
            {order.line_items?.map((item: any) => (
              <div key={item.id} className="flex items-center justify-between p-3 bg-white rounded-xl">
                ...
                <div className="text-right">
                  <p className="text-gray-900 text-sm">{item.quantity}x {formatCurrency(item.price)}</p>
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <select
          ...
          className="px-4 py-2.5 bg-white border border-gray-200 rounded-xl text-gray-900 focus:outline-none focus:border-orange-500"
        >
