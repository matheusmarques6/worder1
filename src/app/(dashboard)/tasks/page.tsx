    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-orange-500 text-white rounded-xl 
      ...
      {stats && (
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
          <div className={`bg-white border rounded-xl p-4 transition-colors cursor-pointer
                          ${statusFilter === '' && !hasActiveFilters ? 'border-orange-300' : 'border-gray-200 hover:border-gray-300'}`}
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-10 py-2.5 bg-white border border-gray-200 rounded-xl 
                       text-gray-900 placeholder:text-gray-400 focus:outline-none focus:border-orange-500"
          />
          {searchQuery && (
            <button
              onClick={() => setSearchQuery('')}
              className="absolute right-3 top-1/2 -translate-y-1/2 p-1 text-gray-400 hover:text-gray-900"
            >
              <X className="w-4 h-4" />
            </button>
          )}
                ...
                <div>
                  ...
                  <select
                    ...
                    className="px-3 py-2 bg-gray-100 border border-gray-300 rounded-lg text-sm 
                               text-gray-900 focus:outline-none focus:border-orange-500 min-w-[140px]"
                  >
