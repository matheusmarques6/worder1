...
interface Resp {
  period: string
  totals: { calls: number; successful: number; failed: number; promptTokens: number; completionTokens: number; totalTokens: number; costUsd: number; unknownCostCalls?: number; avgDurationMs: number }
  grouped: Array<{ key: string; calls: number; tokens: number; costUsd: number }>
  budget: { allowed: boolean; budgetUsd: number | null; spentUsd: number; usedPct?: number; hasUnknownCost?: boolean } | null
}
