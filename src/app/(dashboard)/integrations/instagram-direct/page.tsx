          ...
          <div className="lg:col-span-2">
            ...
            {isConnected && (
              <motion.div
                ...
                className="mt-6 bg-dark-900 rounded-2xl border border-dark-700 p-6"
              >
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-dark-400">Configure gatilhos automaticos</p>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  <Link
                    ...
                    className="flex items-center justify-between p-4 bg-dark-800 rounded-xl hover:bg-dark-750 transition-colors"
                  >
