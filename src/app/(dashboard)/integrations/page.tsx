...
function IntegrationCard({
  ...
  return (
    <motion.div
      ...
      className={`
        relative bg-white border rounded-2xl p-5 transition-all duration-200 group
        ${isInstalled 
    ...
    >
      ...
      {integration.is_builtin && (
        <div className="absolute -top-2 -left-2">
          <span className="flex items-center gap-1 px-2 py-0.5 bg-gradient-to-r from-orange-500 to-accent-500 rounded-full text-[10px] font-bold text-white shadow-lg">
      ...
      <div className="mt-4 flex items-center gap-2">
        {isInstalled ? (
          <>
            <button
              onClick={onConfigure}
              className="flex-1 flex items-center justify-center gap-2 px-3 py-2 bg-gray-100 hover:bg-gray-100 rounded-xl text-sm text-gray-900 transition-colors"
            >
          ...
          <button
            onClick={onInstall}
            className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-transparent border-2 border-orange-500 text-orange-500 hover:bg-orange-500 hover:text-gray-900 rounded-xl text-sm font-medium transition-all duration-200"
          >
      ...
      <div className="flex flex-col lg:flex-row gap-4">
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 bg-white border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:border-orange-300"
          />
        </div>
    ...
    >
      ...
      >
        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl text-gray-900 focus:outline-none focus:border-orange-500"
            >
          ...
          <div>
            ...
            <div className="flex gap-2 mb-2">
              <input
                ...
                className="flex-1 px-4 py-2 bg-white border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:border-orange-500"
              />
              <button
                onClick={addTag}
                className="px-4 py-2 bg-gray-100 hover:bg-gray-200 rounded-xl text-gray-900 transition-colors"
              >
            ...
            {autoTags.length > 0 && (
              <div className="flex flex-wrap gap-2">
                {autoTags.map((tag) => (
                  <span
                    key={tag}
                    className="flex items-center gap-1 px-2 py-1 bg-orange-50 text-orange-500 rounded-lg text-sm"
                  >
                    {tag}
        ...
        <div className="p-6 border-t border-gray-200 flex items-center justify-end gap-3">
          <button
            onClick={onClose}
            className="px-4 py-2.5 bg-gray-100 hover:bg-gray-200 rounded-xl text-gray-900 transition-colors"
          >
            Cancelar
          </button>
          <button
            ...
            className="flex items-center gap-2 px-6 py-2.5 bg-orange-500 hover:bg-orange-600 disabled:opacity-50 rounded-xl text-white font-medium transition-colors"
          >
            {loading ? (
              <>
