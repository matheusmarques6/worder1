...
export async function GET(req: NextRequest) {
  ...
  if (aiErr) {
    ...
    // Erro de leitura sobe para o cron ser repetido; escolher legacy ou runtime
    // por estado stale pode criar dois mecanismos de resposta. Linha pulada
    // aqui NÃO tem ai_pending zerado: o cron não é dono desse estado e a org
    // pode voltar para legacy.
