      ...
      for (const tpl of templates) {
        const { data: newTpl, error: tplErr } = await supabase
          ...
          .insert({
            ...
            // from_name/from_email/reply_to/tags não existem em
            // email_templates — o remetente é resolvido por loja no
            // envio, não guardado no modelo. Com essas colunas no
            // payload, o PostgREST recusava a linha inteira e clonar a
