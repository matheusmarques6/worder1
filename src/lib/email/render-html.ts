...
// =============================================
// injectEmailTracking foi removida.
//
// Ela injetava pixel e reescrevia links usando
// `process.env.NEXT_PUBLIC_APP_URL || 'https://worder1.vercel.app'` — o
// host do painel, com uma URL de preview da Vercel embutida como reserva.
// Não tinha nenhum chamador, mas era uma armadilha: quem a usasse
// produziria e-mail com links num host e o resto noutro.
//
// O caminho certo é `prepareEmailHtml` (src/lib/email/render.ts), que
// recebe o host de rastreamento resolvido por `getTrackingBaseUrl`
// (loja → organização → padrão da plataforma) e faz pixel, reescrita de
// clique e descadastro com ele.
// =============================================
