...
export const FIELD_CATALOG: FieldDef[] = [
  ...
  { key: 'region',      label: 'Estado/Região', category: 'location', type: 'string',
    source: { kind: 'contact_column', column: 'region' } },
  { key: 'city',        label: 'Cidade',      category: 'location', type: 'string',
    source: { kind: 'contact_column', column: 'city' } },
  { key: 'postal_code', label: 'CEP',         category: 'location', type: 'string',
    source: { kind: 'contact_column', column: 'postal_code' } },
  ...
  { key: 'days_since_last_active', label: 'Dias desde última atividade', category: 'engagement', type: 'number',
    source: { kind: 'contact_column', column: 'days_since_last_active' } },

  // ────────── CONSENTIMENTO ──────────
  { key: 'email_consent',    label: 'Consentimento email',    category: 'consent', type: 'boolean',
    source: { kind: 'contact_column', column: 'email_consent' } },
  { key: 'sms_consent',      label: 'Consentimento SMS',      category: 'consent', type: 'boolean',
    source: { kind: 'contact_column', column: 'sms_consent' } },
  { key: 'whatsapp_consent', label: 'Consentimento WhatsApp', category: 'consent', type: 'boolean',
    source: { kind: 'contact_column', column: 'whatsapp_consent' } },
  { key: 'unsubscribed_at',  label: 'Data de descadastro',    category: 'consent', type: 'date',
    source: { kind: 'contact_column', column: 'unsubscribed_at' } },

  // ────────── COMÉRCIO ──────────
  { key: 'total_orders',     label: 'Total de pedidos',  category: 'commerce', type: 'number',
    source: { kind: 'contact_column', column: 'total_orders' } },
  { key: 'total_revenue',    label: 'Receita total',     category: 'commerce', type: 'number',
