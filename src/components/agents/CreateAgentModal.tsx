...
const providerColors: Record<string, string> = {
  ...
  together: 'bg-yellow-500/20 text-yellow-400 border-yellow-500/30',
  openrouter: 'bg-teal-500/20 text-teal-400 border-teal-500/30',
  perplexity: 'bg-sky-500/20 text-sky-400 border-sky-500/30',
}
