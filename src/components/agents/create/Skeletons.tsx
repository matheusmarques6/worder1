  ...
  return (
    <div className="bg-zinc-800/50 rounded-xl p-4 animate-pulse">
      <div className="flex items-center gap-2 mb-2">
        <div className="w-4 h-4 bg-zinc-700/50 rounded" />
        <div className="w-20 h-3 bg-zinc-700/50 rounded" />
      </div>
      <div className="w-16 h-8 bg-zinc-700/50 rounded" />
    </div>
  );
}
    ...
    <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
      {Array.from({ length: count }).map((_, i) => (
        <motion.div
          ...
          className="p-4 rounded-xl border border-zinc-700 bg-zinc-800/50 animate-pulse"
        >
          <div className="w-12 h-12 rounded-lg bg-zinc-700/50 mb-3" />
          <div className="w-24 h-5 bg-zinc-700/50 rounded mb-2" />
          <div className="w-full h-4 bg-zinc-700/50 rounded" />
        </motion.div>
      ))}
    </div>
  );
