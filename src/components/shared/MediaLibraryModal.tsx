                ...
                <div className="grid grid-cols-4 gap-3">
                  {filtered.map(img => {
                    ...
                    return (
                      ...
                      >
                        <Image src={img.url} alt={img.name || ''} fill sizes="(max-width: 720px) calc((100vw - 92px) / 4), 157px" className="object-cover" loading="lazy" unoptimized={img.type === 'image/svg+xml'} />
