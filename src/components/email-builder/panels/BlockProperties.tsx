    ...
    case 'abandoned-cart':
      return (
        <div className="space-y-4">
          ...
          {/* Button text + styling — only relevant when showButton is on. Placed
              right after the checkboxes so it's visible without scrolling. */}
          {p.showButton !== false && (
            <div className="border border-zinc-200 rounded-lg p-3 bg-zinc-50/50">
              <div className="flex items-center gap-2 mb-3">
                <div className="w-6 h-6 rounded bg-zinc-900 flex items-center justify-center">
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2"><rect x="3" y="8" width="18" height="8" rx="2"/><path d="M8 12h8"/></svg>
                </div>
                <p className="text-[12px] font-semibold text-zinc-800">Texto e estilo do botão</p>
              </div>
              <div className="space-y-2">
