...
export const MERGE_TAGS: MergeTagGroup[] = [
  ...
  },
  {
    ...
    tags: [
      { name: 'Nome do Produto', value: '{{event.ProductName}}', sample: 'Camiseta Premium', hint: 'Primeiro produto do evento' },
      { name: 'Preço do Produto', value: '{{event.Price}}', sample: '89.90' },
      { name: 'Preço Comparativo', value: '{{event.CompareAtPrice}}', sample: '129.90' },
      ...
      { name: 'SKU', value: '{{event.SKU}}', sample: 'CAM-001' },
      { name: 'Variante', value: '{{event.VariantName}}', sample: 'Azul / M' },
      { name: 'Marca', value: '{{event.Brand}}', sample: 'Azzurro Milano' },
      { name: 'ID do Pedido', value: '{{event.OrderId}}', sample: '#1234' },
      { name: 'Numero do Pedido', value: '{{event.OrderNumber}}', sample: '1234' },
      { name: 'Valor Total', value: '{{event.Value}}', sample: '199.90' },
      { name: 'Subtotal', value: '{{event.SubtotalPrice}}', sample: '189.90' },
      { name: 'Total de Descontos', value: '{{event.TotalDiscounts}}', sample: '20.00' },
      { name: 'Moeda', value: '{{event.Currency}}', sample: 'BRL' },
      { name: 'Qtd. de Itens', value: '{{event.ItemCount}}', sample: '3' },
      { name: 'URL do Checkout', value: '{{event.CheckoutURL}}', sample: 'https://loja.com/checkout/recover' },
      { name: 'URL do Pedido', value: '{{event.order_status_url}}', sample: 'https://loja.com/orders/...' },
      ...
      { name: 'Codigo de Desconto', value: '{{event.DiscountCode}}', sample: 'BEMVINDO10' },
      { name: 'Status Financeiro', value: '{{event.FinancialStatus}}', sample: 'paid' },
      { name: 'Status Envio', value: '{{event.FulfillmentStatus}}', sample: 'fulfilled' },
      { name: 'Numero de Rastreio', value: '{{event.TrackingNumber}}', sample: 'BR123456789' },
      { name: 'URL de Rastreio', value: '{{event.TrackingUrl}}', sample: 'https://rastreio.correios.com.br/...' },
      { name: 'Transportadora', value: '{{event.TrackingCompany}}', sample: 'Correios' },
    ],
  },
  {
