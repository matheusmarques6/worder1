...
export const BLOCK_DEFS: BlockDef[] = [
  ...
  { type: 'button', label: 'Botão', icon: 'MousePointerClick', category: 'Conteúdo',
    defaultProps: {
      ...
      bgColor: '#18181B', textColor: '#FFFFFF',
  ...
  { type: 'product-grid', label: 'Produtos', icon: 'ShoppingBag', category: 'E-commerce',
    defaultProps: {
      ...
      buttonColor: '#18181B', buttonTextColor: '#FFFFFF', buttonRadius: 6,
      nameFontSize: 14, nameColor: '#111827', nameWeight: '600',
      priceFontSize: 16, priceColor: '#18181B', priceWeight: '700',
  ...
  { type: 'split', label: 'Dividido', icon: 'Columns', category: 'Conteúdo',
    defaultProps: {
      ...
      buttonText: 'Saiba Mais', buttonHref: '#', buttonColor: '#18181B', buttonTextColor: '#FFFFFF',
