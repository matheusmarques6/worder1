...
const BASE_SETTINGS: EmailDocument['settings'] = {
  ...
  textStyles: {
    ...
    link: { color: '#18181B', underline: true },
  },
  buttonStyles: {
    primary: { bgColor: '#18181B', textColor: '#FFFFFF', borderRadius: 8, fontWeight: 'bold' },
    secondary: { bgColor: '#FFFFFF', textColor: '#18181B', borderRadius: 8, fontWeight: 'bold' },
  },
}
...
const blackFridayDoc: EmailDocument = {
  ...
  sections: [
    section([
      block('text', {
        contentHtml: '<h1 style="margin:0 0 10px;text-align:center;font-size:36px;font-weight:700;color:#FFFFFF;letter-spacing:2px;">BLACK FRIDAY</h1><p style="margin:0;text-align:center;font-size:20px;color:#18181B;font-weight:700;">ATÉ 70% OFF</p>',
        fontSize: 36,
        color: '#FFFFFF',
        lineHeight: 1.2,
        align: 'center',
