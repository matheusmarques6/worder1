...
const PRIORITIES = [
  { value: 'low', label: 'Baixa', color: 'text-dark-400' },
        ...
        >
          ...
          <div className="p-6 space-y-5">
            ...
            {(contactName || orderNumber) && (
              <div className="flex flex-wrap gap-2 p-3 bg-dark-700/50 rounded-xl">
                {contactName && (
                  <span className="inline-flex items-center gap-1.5 px-2 py-1 bg-dark-600 rounded-lg text-sm text-white">
                    <User className="w-3.5 h-3.5 text-primary-400" />
                    {contactName}
                  </span>
                )}
                {contactPhone && (
                  <span className="inline-flex items-center gap-1.5 px-2 py-1 bg-dark-600 rounded-lg text-sm text-dark-300">
                ...
                {orderNumber && (
                  <span className="inline-flex items-center gap-1.5 px-2 py-1 bg-dark-600 rounded-lg text-sm text-success-400">
                ...
                {PRIORITIES.map((p) => (
                  <button
                    ...
                    className={`flex-1 py-2 px-3 rounded-xl border text-sm font-medium transition-all ${
                      priority === p.value
                        ? `${p.color} bg-dark-700 border-current`
