...
const TRIGGER_OPTIONS: NodeItemConfig[] = [
  ...
  { type: 'trigger_whatsapp_optin', label: 'Confirmou WhatsApp via Popup', description: 'Dispara quando a pessoa confirma o opt-in de WhatsApp pedido por um popup', icon: MessageSquare, category: 'trigger', color: '#10b981' },
