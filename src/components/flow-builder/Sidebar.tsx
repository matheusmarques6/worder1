...
const TRIGGER_OPTIONS: NodeItemConfig[] = [
  ...
  { type: 'trigger_whatsapp_first', label: 'Primeira mensagem', description: 'Dispara na primeira mensagem de um contato novo', icon: MessageCircle, category: 'trigger', color: '#10b981' },
  { type: 'trigger_rfm_change', label: 'Mudou segmento RFM', description: 'Dispara quando contato muda de segmento RFM', icon: Users, category: 'trigger', color: '#10b981' },
...
const LIBRARY_SECTIONS: SectionConfig[] = [
  {
    ...
    items: [
      ...
      { type: 'action_whatsapp_wait', label: 'Aguardar resposta', description: 'Aguarda resposta do contato com timeout', icon: Clock, category: 'action', color: '#3b82f6' },
      { type: 'action_whatsapp_condition', label: 'Condição WhatsApp', description: 'Verifica keyword na resposta', icon: GitBranch, category: 'condition', color: '#f59e0b' },
      ...
      { type: 'action_generate_coupon', label: 'Gerar cupom Shopify', description: 'Gera cupom de desconto Shopify', icon: Tag, category: 'action', color: '#f97316' },
      { type: 'action_back_in_stock', label: 'Notificar estoque', description: 'Notifica quando produto volta ao estoque', icon: ShoppingBag, category: 'action', color: '#84cc16' },
