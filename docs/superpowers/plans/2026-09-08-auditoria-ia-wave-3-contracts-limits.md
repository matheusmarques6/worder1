...
Evidência de 2026-09-14: `f9bb5e8a`. REDs confirmaram 4 falhas TS e 3 Python em schedules malformados, 2 bypasses indevidos no sender, além das divergências iniciais de horário, keyword não-string e confirmação bloqueada. GREEN final: 18 casos de horário e 12 de estado na fixture comum; `463 passed, 1 skipped` em Vitest, `93 passed` nos focais Python, typecheck e Ruff verdes. Gate oficial no descartável `6d2c9f8a4b3e47d19a05c8e7f1b24630`: `27 tests`, zero failures/errors/skips, estado `stopped`, zero contêineres e volumes. Revisões finais: PASS/APPROVED após corrigir Step 5, fail-closed de JSON inválido e restringir o bypass à confirmação configurada exata.
